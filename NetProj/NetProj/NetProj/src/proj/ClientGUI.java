...
public class ClientGUI implements FileTransferListener  {
    ...
    private JPanel createTopPanel() {
        ...
        JComboBox<String> statusCombo = new JComboBox<>(new String[]{"Active", "Busy", "Away"});
    ...
    private JPanel createBottomPanel() {
        ...
        broadcastButton = createStyledButton("Broadcast", new Color(100, 149, 237), 100, 35);
    ...
    private void initializeInactivityTimer() {
        inactivityTimer = new Timer(180000, e -> {
    ...
    private void resetInactivityTimer() {
        if (client.getStatus().equals("Away")) {
            ...
            appendStatus("Status changed to Active");
        }
    ...
    class UserListRenderer extends DefaultListCellRenderer {
        ...
        public Component getListCellRendererComponent(JList<?> list, Object value,
            ...
            if (value != null) {
                ...
                else if (val.contains("Away")) setForeground(userColors[2]);
